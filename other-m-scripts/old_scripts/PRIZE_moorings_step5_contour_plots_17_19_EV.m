...
pt1 = subplot(2,1,1);
hold on
imagesc(EAST_17.interp_time,EAST_17.interp_depth,EAST_17.interp_temp)
imagesc(EAST_18.interp_time,EAST_18.interp_depth,EAST_18.interp_temp)
...
pt2 = subplot(2,1,2);
hold on
imagesc(WEST_17.interp_time,WEST_17.interp_depth,WEST_17.interp_temp)
imagesc(WEST_18.interp_time,WEST_18.interp_depth,WEST_18.interp_temp)
...
ps1 = subplot(2,1,1);
hold on
imagesc(EAST_17.interp_time,EAST_17.interp_depth,EAST_17.interp_sal)
imagesc(EAST_18.interp_time,EAST_18.interp_depth,EAST_18.interp_sal)
title ('Salinity EAST');
set(gca,'YDir','reverse')
ylabel('Depth (m)');
set(gca,'xtick',[datenum('01-Sep-17'):91.5:datenum('04-Dec-19')])
...
ps2 = subplot(2,1,2);
hold on
imagesc(WEST_17.interp_time,WEST_17.interp_depth,WEST_17.interp_sal_v2)
imagesc(WEST_18.interp_time,WEST_18.interp_depth,WEST_18.interp_sal)
title ('Salinity WEST');
set(gca,'YDir','reverse')
ylabel('Depth (m)');
set(gca,'xtick',[datenum('01-Sep-17'):91.5:datenum('04-Dec-19')])
