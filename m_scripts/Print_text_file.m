...
S=round(prize_east_17_gridded.temp(:,3:end),2);
P=round(prize_east_17_gridded.temp(:,3:end),2);
...
S=round(prize_west_17_gridded.temp(:,3:end),2);
P=round(prize_west_17_gridded.temp(:,3:end),2);
