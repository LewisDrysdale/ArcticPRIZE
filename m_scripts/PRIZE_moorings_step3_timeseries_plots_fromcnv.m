...
EAST_start=datenum('20-Jun-2018 12:00:00');
EAST_end=datenum('18-Nov-2019 16:00:00'); % TBC!
EAST_SBE37_SN = [7289,7290,7291,7292];
EAST_SBE37_depth = [35,76,110,170];
...
for j=1:length(EAST_SBE37_SN)
    ...
    % Read data
    fl = ['EAST18_SBE37_' num2str(EAST_SBE37_SN(j)) '.cnv'];
    ...
    ind=find(mtime>=EAST_start & mtime<=EAST_end);
